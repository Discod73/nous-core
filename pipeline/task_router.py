...
class TaskRouter:
    def __init__(self):
        import os as _os
        self.ollama_url = _os.environ.get("NOUS_OLLAMA_URL", "http://localhost:11434")
    ...
    def fallback_response(self, reason):
        ...
        return {
            ...
            "suggestion": "Hvis dette fortsætter, tjek at Jetson-enheden kører korrekt og er tilgængelig."
        }
