...
| Task Router + Circuit Breaker | Fallback ved Jetson OOM | ✅ |
...
| Respeaker xvf38000 | Ikke startet | ⏳ |
...
| Lyd test | Desktop session: TTS afspiller OK | ✅ |
...
| Mikrofon optagelse | Tydelig lyd, 4-kanal | ✅ |
| STT (Whisper) | Planlagt til Session 4 | ⏳ |
| Arducam | Venter på fysisk tilslutning | ⏳ |
| SearXNG | Kører, host network | ✅ |
| Privacy Guard (Presidio) | Ikke startet | ⏳ |

Session 4: Privacy Guard, Legal Engine, Arducam, Whisper STT
