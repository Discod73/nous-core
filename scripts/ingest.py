...
Brug: python3 ingest.py /sti/til/fil.pdf --wing boernesag --scope SECRET
"""
import argparse, os, sys, uuid, json
...
# Standard wing-navne — tilpas til dine wings.json-navne
WING_MAP = {
    "legal":      {"SECRET": "legal_secret",      "PRIVATE": "legal_private"},
    "personal":   {"SECRET": "personal_private",   "PRIVATE": "personal_private"},
    "household":  {"SECRET": "household_private",  "PRIVATE": "household_private"},
    "work":       {"SECRET": "work_private",       "PRIVATE": "work_private"},
}
...
if __name__ == "__main__":
    ...
    p.add_argument("file")
    p.add_argument("--wing", choices=list(WING_MAP.keys()), default=list(WING_MAP.keys())[0])
